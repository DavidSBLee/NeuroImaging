...
# Updated content(8/21): Autoprocessing was failng due to permission, so granted full executatble permission
# Updated content(8/22): scanname variable now gets "01, 02, 03" instead of "1, 2, 3" 
...
for dicom in dicoms:
    ...
    for files in unzippedDicoms:
        ...
        if "T1w" in scanName:
            if os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/anat/sub-" + subNum + "_T1w.nii.gz") == True:
                print "pass"
            elif os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/anat/sub-" + subNum + "_T1w.nii.gz") == False:
        ...
        if "WATER__fmap" in scanName:
            if os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/fmap/sub-" + subNum + "_magnitude.nii.gz") == True:
                print "pass"
            elif os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/fmap/sub-" + subNum + "_magnitude.nii.gz") == False:
                os.makedirs(dicomSet)
                os.chdir(dicomSet)
                os.makedirs(scanName)
                os.chdir(scanName)
        ...
        if "FieldMap__fmap" in scanName:
            if os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/fmap/sub-" + subNum + "_fieldmap.nii.gz") == True:
                print "pass"
            elif os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/fmap/sub-" + subNum + "_fieldmap.nii.gz") == False:
                os.makedirs(dicomSet)
                os.chdir(dicomSet)
                os.makedirs(scanName)
                os.chdir(scanName)
        ...
        if "asl" in scanName:
            if os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/asl/sub-" + subNum + "_asl.nii.gz") == True:
                print "pass"
            elif os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/asl/sub-" + subNum + "_asl.nii.gz") == False:
                os.makedirs(dicomSet)
                os.chdir(dicomSet)
                os.makedirs(scanName)
                os.chdir(scanName)
...
"""
        if "asl" in scanName:
            if os.path.isfile("/study3/midus3/processed_data/MIDUS3_Imaging/sub-" + subNum + "/asl/sub-" + subNum + "_asl.nii.gz") == True:
                ...
                os.chdir(niftiSet)
                os.makedirs("asl")
                os.system("dcm2niix -f " + niftiFolderName + "_" + scanName + " -o /study/midus3/processed_data/MIDUS3_Imaging/" + "sub-" + subNum + "/asl/" + " -z y /studicomdir/" + dicomFolderName + "/" + scanName)
                print "----------" + scanName + " Conversion Complete----------"
                print "----------Deleting Unzipped Dicoms----------"
