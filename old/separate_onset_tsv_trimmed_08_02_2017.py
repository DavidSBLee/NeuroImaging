...
for tsv in tsvPath:
	...
	with open(tsv, 'rb') as tsvFile, open('/study3/midus3/processed_data/MIDUS3_Imaging/OnsetTest/Temporary/sub-' + subNum + '_computed-03.tsv', 'wb') as newTsv:
		fields = ('onset_iaps_trimmed',
		'Duration_IAPS',
		'onset_face_trimmed',
		'Duration_Face',
